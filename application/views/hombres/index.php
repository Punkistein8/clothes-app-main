        ...
        <form action="<?php echo site_url('hombres/guardarPrendaHombre'); ?>" method="post">
          <ul class="flex flex-col gap-3">
            ...
            <li class="flex flex-col justify-center">
              ...
              <select class="p-2 rounded-md" id="tipo" name="tipo_ph" required>
  ...
  <?php foreach ($listaHombres as $prendaHombre) : ?>
    <div class="flex">
      <div class="flex flex-col gap-1">
        ...
        <a href="<?php echo site_url('hombres/cargarDatosPrenda') . '/' . $prendaHombre->id_ph ?>" aria-label="Editar Prenda" class="hint--left hint--rounded hover:scale-110 transition-all ease-in-out cursor-pointer z-10 translate-x-20 translate-y-6 relative flex justify-center items-center bg-teal-600 hover:bg-teal-700 w-12 h-12 rounded-full">
        ...
        <a href="<?php echo site_url('hombres/eliminarHombre') . '/' . $prendaHombre->id_ph ?>" aria-label="Borrar Prenda" class="hint--left hint--rounded hover:scale-110 transition-all ease-in-out cursor-pointer z-10 translate-x-20 translate-y-6 relative flex justify-center items-center bg-red-600 hover:bg-red-700 w-12 h-12 rounded-full">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="absolute w-6 h-6 text-white">
