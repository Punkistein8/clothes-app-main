...
<?php else : ?>
  <div class="m-10 flex justify-center">
    <h1 class="text-2xl py-3 px-32 rounded-md bg-emerald-400 text-center text-neutral-100">Esta prenda <span class="font-semibold text-gray-900">no existe</span></h1>
  </div>
<?php endif; ?>